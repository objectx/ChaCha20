...
TEST_CASE ("Test ChaCha::DJB with small key") {
...
TEST_CASE ("Test ChaCha::DJB with large key") {
...
TEST_CASE ("ChaCha::DJB property") {
    rc::prop ("roundtrip", [] () {
        ...
        RC_ASSERT (std::equal (expected.begin (), expected.end (), actual.begin (), actual.end (), [] (auto a, auto b) { return a == b; }));
    });
